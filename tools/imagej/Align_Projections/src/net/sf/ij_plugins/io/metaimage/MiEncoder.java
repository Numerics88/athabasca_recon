...
public final class MiEncoder {
    ...
    public static void writeHeader(final ImagePlus imp, final FileOutputStream fileOutputStream, final String rawDataFileName) throws MiException, IOException {
     ...
     */
    public static void writeHeader(final ImagePlus imp, final String headerFileName,
     ...
     * @throws MiException In case of error when saving the header.
     */
    public static String createHeaderText(final ImagePlus imp, final String rawDataFileName)
            throws MiException {
    ...
    public static void writeRawImage(ImagePlus imp, FileOutputStream fileOutputStream) throws MiException {
     ...
     */
    public static void writeRawImage(final ImagePlus imp, final String fileName) throws MiException {
